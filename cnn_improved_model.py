...
# Tworzenie struktury folderów dla wyników ulepszonego CNN
...
# Dajemy większą wagę klasie melanoma, aby zwiększyć jej czułość
...
# Definicja ulepszonego modelu CNN z regularyzacją L2
model = Sequential([
...
# Dodajemy cykliczny harmonogram stopy uczenia
